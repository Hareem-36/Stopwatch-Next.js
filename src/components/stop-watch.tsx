...
export default function StopWatch() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-fuchsia-600 to-pink-50">
      <Card className="w-full max-w-lg">
        <CardHeader className="flex flex-col items-center justify-center">
        <CardTitle className="text-5xl font-bold text-fuchsia-800 underline">Stopwatch</CardTitle>

          <CardDescription className=" font-bold text-lg text-gray-800">
            Track your time with this stopwatch.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center gap-8 p-4">
          {/* Display the elapsed time */}
          <div className="text-8xl font-bold  text-blue-900">
          ...
          <div className="flex gap-4 ">
            <Button
              ...
              className="px-6 py-2 text-lg font-medium rounded-lg bg-sky-700 font-bold "
            >
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="max-h-[300px] overflow-auto p-0">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="text-left text-blue-900 font-bold">Lap</TableHead>
                      <TableHead className="text-right text-blue-900 font-bold">Time</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
